...
const WholesaleAssignSalesman = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        console.log("wholesaleAssignSalesman :", formData);
                                ...
                                >
                                    ...
                                    <div className='row gy-3'>
                                        ...
                                        <div class="col-sm-6"><label class="form-label">Wholesaler Name</label>
                                            <div class="position-relative"><select class="form-select" name="name" value={formData.name} onChange={handleChange} >
...
export default WholesaleAssignSalesman;